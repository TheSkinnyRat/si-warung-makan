      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 mt-md-4 text-center">
            <h1 class="h3 text-gray-800 font-weight-bold">Proses</h1>
            <p class="m-0">Konfirmasi proses pesanan</p class="m-0">
          </div>
          <div class="col-12">
            @if (session('message'))
          ...
          <div class="col-12">
            <div class="row">
              <div class="col-12 text-center">
                ...
                <a href="{{ route('backend.admin.proses') }}" class="btn btn-info btn-sm disabled"><i class="fas fa-sync-alt"></i> Proses</a>
                    ...
                    <div class="card-footer text-muted">
                      <div class="row align-items-center">
                        <div class="col-6 font-weight-bold">
                          Jml Pesanan: {{ $count_kuantitas }}
                        </div>
                        <div class="col-6">
                          <div class="text-right">
                            <a href="{{ route('backend.admin.proses.do', ['id' => $pemesanan->id_pemesanan]) }}" class="btn btn-info btn-sm">
                              Proses Pesanan
                            </a>
                          </div>
                        </div>
