              ...
              <div class="card-header py-3">
                <div class="row align-items-center">
                  ...
                  <div class="col-2 text-right">
                    <a href="{{ route('backend.superadmin.kategori.add') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                      @foreach ($kategoris as $kategori)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('backend.superadmin.kategori.edit', ['id' => $kategori->id_kategori]) }}" class="btn btn-info btn-sm"><i class="far fa-edit"></i></a>
                            <a href="{{ route('backend.superadmin.kategori.delete', ['id' => $kategori->id_kategori]) }}" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i></a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
